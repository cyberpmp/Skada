...
def run(ctx: Context):
    ...
    ctx.run('''
      ...
      -- the bar scale spans effective + overheal so the overheal continuation fits
      assert(meter.display[1].extra == 500 and meter.paintMaximum == 900, tostring(meter.paintMaximum))
